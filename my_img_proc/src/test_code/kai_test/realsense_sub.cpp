// Subscribe realsense image and publish 3d point
//-----------------------------------------------------
// INCLUDE FILES
//-----------------------------------------------------
...
int main(int argc, char **argv)
{
  ...
  image_transport::Subscriber image_sub_depth = it.subscribe(IMAGE_DEPTH, 1, imageCb_depth);

  // Subscribe to the /camera raw image topic
  image_transport::Subscriber image_sub_position = it.subscribe(IMAGE_TOPIC, 1, imageCb_position);
