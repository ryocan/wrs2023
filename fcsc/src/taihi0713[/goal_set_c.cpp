...
#define mid2_x 2.0
#define mid2_y 2.55
#define midavo_a_x 1.5 //回避場所に行く時の経由地点
#define midavo_a_y 1.0  //回避場所に行く時の経由地点
...
// #define mid2_x 1.0
// #define mid2_y 0
// #define midavo_a_x 1.00 //回避場所に行く時の経由地点
// #define midavo_a_y 0  //回避場所に行く時の経由地点
// #define midavo_b_x 1   //回避場所から棚に戻る時の経由地点
...
/*  if (avo_input_flag == 1 || avo_input_flag == 3)
  {
    // reach avo
    if (status_id == 3 && sta == 9)
    {
      ...
      sta = 6;
      flag_pub.publish(output_flag);
      ROS_INFO("output_flag -- %d",output_flag.data);
    }
