...
#define shelf_x 1.023640751838684
#define shelf_y 1.2648367881774902
#define avo_x 2.223640751838684
#define avo_y 1.12648367881774902
#define back_x  0.0
#define back_y 0.0

#define mid_x 1.023640751838684
#define mid_y 0.0
#define mid2_x 2.023640751838684
#define mid2_y 2.2648367881774902
...
else if(avo_input_flag != 0 && avo_input_flag != 2 && avo_input_flag != 3 && avo_input_flag != 6 && avo_input_flag != 7){
    //kaihi recuest
  if(sta == 3){
    output_flag.data = 1;
    sta = 3;
